var stim_properties = [
  { property: "have four legs", type: "physical", observable_property: "has four legs", duration_observation: "directly_observable"},
  { property: "have spots", type: "physical", observable_property: "has spots", duration_observation: "directly_observable"},
  { property: "have brown fur", type: "physical" , observable_property: "has brown fur", duration_observation: "directly_observable"},
  { property: "have very long wings", type: "physical" , observable_property: "has very long wings", duration_observation: "directly_observable"},
  ...
  { property: "have intensely beautiful feathers", type: "physical", observable_property: "has intensely beautiful feathers", duration_observation: "directly_observable"},
  { property: "live to be twenty years old", type: "physical", observable_property: "will live to be twenty years old"},
  // { property: "live to be a hundred years old", type: "physical", observable_property: "is a hundred years old"},
  { property: "live to be five hundred years old", type: "physical", observable_property: "will live to be five hundred years old"},
  ...
  { property: "know how to ride bicycles", type: "psychological", observable_property: "knows how to ride a bicycle"},
  ...
  { property: "go bald", type: "disease_self", observable_property: "is bald"},
