...
predicted human generic truth judgments with high quantitative accuracy.
Here, we test the adequacy of this model to account for the
belief-updating mechanism of generic statements: How novel generics are
interpreted. This model uniquely predicts the existence of generics with
\emph{weak interpretations}, which with we confirm with behavioral
