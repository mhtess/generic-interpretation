...
Thus, in addition to the cost of the utterance, the speaker's production decision reflects the probability of the prevalence level the speaker intends to convey, $r$ (i.e., their belief about how many of the category have the property), under the literal generic interpretation distribution~vs.~the prior distribution (Figure~\ref{fig:tripartite}A). 
