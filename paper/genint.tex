...
\authornote{This manuscript is currently in prep. Comments or
suggestions should be directed to MH Tessler.
...
\abstract{
Generic language (e.g., ``Birds have hollow bones'') conveys
generalizations about categories and is believed to be a fundamental and
ubiquitous mechanism of learning without direct experience. Interpreting
generics, however, involves an extreme dependence on context that has
made the precise articulation of how generic language updates beliefs
beyond the reach of any extant theory of generics. Recently, Tessler and
Goodman (n.d.) proposed a model for the meaning of generics as a vague
quantifier operating over rich prior knowledge about properties, which
predicted human truth judgments with high quantitative accuracy. Here,
we test the adequacy of this model to account for the belief-updating
mechanism of generic statements: How novel generics are interpreted.
Additionally, this model uniquely predicts the existence of generics
with \emph{weak interpretations}, which with we confirm with behavioral
experiments. \emph{Weak generics} pose a new challenge for theories that
only view generics as conveying strong implications.
