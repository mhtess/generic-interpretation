...
We recruited 144 participants from MTurk.
...
On each trial, participants read a bare plural statement about a familiar property $F$ applying to a novel animal category $K$ (e.g., "Javs attack hikers").
