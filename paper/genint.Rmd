...
abstract: |
  Generic language (e.g., "Birds have hollow bones") conveys generalizations about categories and is believed to be a fundamental and ubiquitous mechanism of learning without direct experience. Interpreting generics, however, involves an extreme dependence on context that has made the precise articulation of how generic language updates beliefs beyond the reach of any extant theory of generics. Recently, @TesslerLangGenUnderReview proposed a model for the meaning of generics as a vague quantifier operating over rich prior knowledge about properties, which predicted human generic truth judgments with high quantitative accuracy. Here, we test the adequacy of this model to account for the belief-updating mechanism of generic statements: How novel generics are interpreted. This model uniquely predicts the existence of generics with *weak interpretations*, which with we confirm with behavioral experiments. *Weak generics* pose a new challenge for theories that only view generics as conveying strong implications. 
  ...
  mutate(distribution = factor(distribution,  levels = distribution.order.levels, labels = distribution.order.labels),
         model = factor(model,
                        levels = c("prior", 
                                   ...
                                   "fixed_0.375", "uncertain", "data"),
                        labels = c("prevalence_prior",
