...
The experiment took on average `r round(d.expt1.time.summary[[1, "aveTime"]], 1)` minutes and participants were compensated \$K.
...
Judgments were obtained for 61 items, of which each participant saw a random selection of 30. 
