...
```{r genInt-prevPrior, fig.width = 11, fig.asp = 0.36, fig.cap="Prevalence priors for a broad set of animal properties. A: Prevalence priors summarized by their relative probability mass at zero-prevalence P(feature is present), and their expected value among non-zero prevalence levels: Prevalence when present. B: Eight example prevalence priors elicited in Expt. 2a. Different prevalence priors give rise to different model predicted implied prevalence."}
