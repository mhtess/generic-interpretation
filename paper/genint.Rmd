...
The results are consistent with @Cimpian2010's findings of generally strong interpretations of novel generic statements, but that also exhibit a sensitivty to theory-based expectations such that generics about accidental properties (e.g., *fungus-covered claws*) are interpreted relatively weakly.
...
In addition, we use more naturalistic properties and measure background knowledge in order to test our computational models.
