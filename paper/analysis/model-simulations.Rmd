...
#save(sims.combined, file = "../cached_results/modelSims-priors_fixedT_uncertainT.RData")


#save(sims.priors, sims.uncertain.thresholds, sims.fixed.thresholds, file = "../cached_results/modelSims-priors_fixedT_uncertainT.RData")
```
